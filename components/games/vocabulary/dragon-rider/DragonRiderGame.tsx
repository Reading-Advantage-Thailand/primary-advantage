...
} from "@/lib/games/dragon-rider/dragonRider";
import type {
  DragonRiderResults,
  DragonRiderRound,
  DragonRiderState,
...
import { RankingDialog } from "@/components/games/vocabulary/dragon-rider/RankingDialog";
...
const ASSETS = {
  gates: withBasePath("/games/dragon-rider/gates-3x3-sheet-facing-up.png"),
  boss: withBasePath("/games/dragon-rider/boss-3x3-sheet-facing-up.png"),
  player: withBasePath("/games/dragon-rider/player-3x3-sheet-facing-down.png"),
  playerCamera: withBasePath(
    "/games/dragon-rider/player-3x3-sheet-facing-camera.png",
  ),
  army: withBasePath("/games/dragon-rider/dragon-army-3x3-sheet-facing-up.png"),
  parallaxTop: withBasePath("/games/dragon-rider/parallax-top-tiling.png"),
  parallaxMiddle: withBasePath(
    "/games/dragon-rider/parallax-middle-tiling.png",
  ),
  parallaxBottom: withBasePath(
    "/games/dragon-rider/parallax-bottom-tiling.png",
  ),
  loadingBackground: withBasePath(
    "/games/dragon-rider/loading-screen-background.png",
  ),
};
...
export function DragonRiderGame({
  ...
  useEffect(() => {
    ...
    return () => undefined;
  }, [state.status, state.correctAnswers, state.attempts, state.dragonCount]);
  ...
  return (
    ...
    >
      ...
      {gamePhase === "start" && (
        ...
        >
          <div className="flex items-center gap-2">
            <div className="flex gap-1 rounded-lg border border-white/10 bg-slate-900/80 p-1">
            ...
            <button
              ...
              className="rounded-full border border-white/10 bg-slate-800 p-2 text-amber-400 transition-colors hover:bg-slate-700"
              title={t("dragonRider.startScreen.rankingButton")}
            >
      ...
      <RankingDialog
        ...
        apiEndpoint="/api/games/dragon-rider/ranking"
