...
export function ActionMenu({
  ...
  return (
    <form
      ...
      className="space-y-3 rounded-xl border border-slate-700/50 bg-slate-900/80 p-4 shadow-lg backdrop-blur-sm"
    >
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
        <Input
          ...
          autoFocus={!disabled}
          ref={inputRef}
          className="h-11 border-slate-700/50 bg-slate-800/60 text-slate-100 placeholder:text-slate-500"
        />
        <Button
          type="submit"
