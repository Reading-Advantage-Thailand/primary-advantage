  ...
  return (
    <section className="w-full p-4 md:p-6">
      <div
        ...
        className="relative flex min-h-70 items-end justify-between gap-6 overflow-hidden rounded-2xl border border-slate-700/50 bg-slate-800/60 p-4 shadow-2xl backdrop-blur-sm md:p-6"
        style={stageStyle}
      >
      ...
      >
        <div className="min-h-30">{actionMenu}</div>
