...
const CUSTOMER_ASSETS: Record<
  CustomerType,
  { sheetKey: "sheet1" | "sheet2"; row: number }
> = {
...
export default function CustomerQueue({ y, width }: CustomerQueueProps) {
  ...
  useEffect(() => {
    const assets = {
      sheet1: withBasePath("/games/potion-rush/character-sheet-adjusted.png"),
      sheet2: withBasePath("/games/potion-rush/character-sheet-2-adjusted.png"),
    };
