...
export default function CauldronStation({
  ...
  useEffect(() => {
    const assets = {
      blue: withBasePath("/games/potion-rush/cauldron-blue.png"),
      green: withBasePath("/games/potion-rush/cauldron-green.png"),
      yellow: withBasePath("/games/potion-rush/cauldron-yellow.png"),
    };
