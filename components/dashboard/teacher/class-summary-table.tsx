...
export function ClassSummaryTable({
  ...
  const t = useTranslations("Teacher.Dashboard.classOverview");
    ...
    <Card>
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          {/* Table */}
          <div className="rounded-md border" role="region">
            <Table>
              <TableHeader>
                <TableRow>
          ...
          {filteredAndSortedClasses.length > 0 && (
            <div className="text-muted-foreground flex items-center justify-between text-sm">
              <p>
                {t("showing", {
                  count: filteredAndSortedClasses.length,
                  total: classes.length,
                })}
              </p>
              <p>
                {t("totalStudents", {
                  count: filteredAndSortedClasses
