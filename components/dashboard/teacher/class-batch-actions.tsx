...
export function ClassBatchActions() {
  ...
  const t = useTranslations("Components.classBatchActions");
      ...
      <Card>
        ...
        <CardContent>
            ...
            {actions.map((action, index) => {
              ...
              return (
                <button
                  ...
                  className="group bg-card relative overflow-hidden rounded-xl border p-6 text-left transition-all hover:scale-105 hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-50"
                >
                  ...
                  <div className="via-primary/50 absolute bottom-0 left-0 h-1 w-full bg-gradient-to-r from-transparent to-transparent opacity-0 transition-opacity group-hover:opacity-100" />
                </button>
              );
            })}
          </div>
          ...
          {selectedStudents.length > 0 && (
            <div className="border-primary/20 bg-primary/5 mt-4 rounded-lg border px-4 py-3">
