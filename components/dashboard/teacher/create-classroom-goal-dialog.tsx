...
export function CreateClassroomGoalDialog({
  ...
  const t = useTranslations("Teacher.Dashboard.classDetail.goals.createDialog");
  ...
  const goalTypes = [
    ...
    {
      value: "XP_WEEKLY",
      label: t("goalTypes.XP_WEEKLY"),
      unit: t("units.xp"),
    },
    {
      value: "ARTICLES_READ",
      label: t("goalTypes.ARTICLES_READ"),
      unit: t("units.articles"),
    },
    {
      value: "READING_TIME",
      label: t("goalTypes.READING_TIME"),
      unit: t("units.minutes"),
    },
    {
      value: "VOCABULARY",
      label: t("goalTypes.VOCABULARY"),
      unit: t("units.words"),
    },
    { value: "STREAK", label: t("goalTypes.STREAK"), unit: t("units.days") },
    {
      value: "CEFR_LEVEL",
      label: t("goalTypes.CEFR_LEVEL"),
      unit: t("units.level"),
    },
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={mutation.isPending}>
              {mutation.isPending ? t("creatingButton") : t("createButton")}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
