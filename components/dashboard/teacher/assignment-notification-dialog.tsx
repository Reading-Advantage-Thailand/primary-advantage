...
export function AssignmentNotificationDialog({
  ...
  const t = useTranslations("Components.assignmentNotificationDialog");
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Badge variant="secondary">
          {selectedAssignments.length} {t("selected")}
        </Badge>
      </div>
                      ...
                      if (isOverdue) {
                        return (
                          ...
                          >
                            ...
                            {t("badges.overdue")} {Math.abs(daysRemaining)}{" "}
                            {t("days")}
                          </Badge>
                        );
                        ...
                        return (
                          ...
                          >
                            <Clock className="h-3 w-3" />
                            {t("badges.daysRemaining")} {daysRemaining}{" "}
                            {t("days")}
                          </Badge>
                        );
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <div className="text-muted-foreground mt-1 flex items-center gap-2 text-sm">
                    ...
                    {t("history.sentTo")} {item.studentCount}{" "}
                    {t("studentsLabel")}
                  </div>
                </div>
                <div className="text-muted-foreground text-xs">
            ...
            >
              {loading ? (
                ...
                <>
                  <BookOpen className="mr-2 h-4 w-4" />
                  {t("sendToSelected", {
                    count: selectedStudentsForNotif.length,
                  })}
                </>
              )}
            </Button>
