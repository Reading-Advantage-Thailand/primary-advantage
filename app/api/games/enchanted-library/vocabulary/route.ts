...
export const GET = withAuth(async (req, context, user) => {
  try {
    ...
    // Shuffle cards using Fisher-Yates, then take up to MAX_VOCABULARY_ITEMS
      ...
      return NextResponse.json(
        {
          ...
          message:
            "Not enough vocabulary with translations. Please read more articles to build your vocabulary.",
        },
        { status: 200 },
      );
    }
    ...
    console.error("Error fetching Enchanted Library vocabulary:", error);
    return NextResponse.json(
      {
        success: false,
