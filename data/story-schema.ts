...
const characterSchema = z.object({
  ...
  description: z
    .string()
    .describe(
      "Personality and role in the story. Must be relatable to the target age group.",
    ),
  visualDescription: z
    .string()
    .describe(
      "A concise physical appearance description suitable for generating consistent character images.",
    ),
});
...
const storyBlueprintSchema = z.object({
  ...
  cefrLevel: cefrLevelEnum.describe(
    "The strictly enforced proficiency level for all generated text.",
  ),
  targetAudience: z
    .string()
    .describe(
    ...
    .array(
      z.object({
        ...
        summary: z
          .string()
          .describe(
            "A 2-3 sentence summary of the events in this specific stage.",
          ),
        plotBeat: z
          .string()
          .describe(
            "The specific narrative action that fulfills this Harmon stage (e.g., 'You': Establish the hero's normal life).",
          ),
        engagementStrategy: z
          .string()
          .describe(
            "The specific technique used to maintain reader interest (e.g., 'Cliffhanger ending', 'Funny mistake').",
          ),
      }),
    )
    .length(8)
    .describe(
      "A strict 8-step outline following Dan Harmon's Story Circle. Each item corresponds to one chapter.",
    ),

  characters: z
    .array(characterSchema)
    .describe(
      "The cast of the story, typically 2-3 main characters to avoid confusion.",
    ),
});
...
const chapterSchema = z.object({
  ...
  chapterBlueprint: z
    .object({
      ...
      grammarFocus: z
        .string()
        .describe(
          "Identify 1-2 specific grammar structures from the 'globalGrammarStructures' to be used naturally within THIS chapter.",
        ),
      pacing: z
        .string()
        .describe(
          "Define the pacing for this chapter (e.g., 'Slow and descriptive' or 'Fast and urgent').",
        ),
      cliffhangerOrHook: z
        .string()
        .describe(
          "Explicitly state the closing sentence or concept that will drive the reader to the next chapter.",
        ),
    })
    .describe(
      "A pre-computation step to plan the specific linguistic and narrative details of this chapter before writing.",
    ),
  ...
  passage: z
    .string()
    .describe(
      "The story text for this chapter. MUST adhere to the level constraints (length, vocabulary, grammar). MUST follow the 'harmonOutline' for plot and the 'chapterBlueprint' for language focus.",
    ),
  ...
  imageDesc: z
    .string()
    .describe(
      "A highly detailed visual prompt for an AI image generator to create a scene specifically for this chapter, maintaining character consistency.",
    ),
    ...
    .array(
      z.object({
        question: z
          .string()
          .describe(
            "A comprehension question based strictly on this chapter's text.",
          ),
        options: z
          .array(z.string())
          .length(4)
          .describe("4 answer options: 1 correct, 3 plausible distractors."),
    ...
    .array(
      z.object({
        question: z
          .string()
          .describe(
            "An open-ended question requiring a short written response.",
          ),
...
export const storyGeneratorSchema = z.object({
  ...
  blueprint: storyBlueprintSchema.describe(
    "The strategic plan for the entire story, including language targets and the narrative arc.",
  ),
...
export const articleGeneratorSchema = z.object({
  ...
  planning: z
    .string()
    .describe("Planning for the passage: strategy for vocabulary and grammar."),
  title: z
    .string()
    .describe(
  ...
  shortAnswerQuestions: z.array(
    z.object({
      question: z.string(),
      answer: z.string(),
    }),
  ),
  longAnswerQuestions: z.array(
    z.object({
      question: z.string(),
    }),
  ),
